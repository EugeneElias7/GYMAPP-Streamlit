...
import pandas as pd
import plotly.express as px# The requirements.txt file is crucial for deployment platforms like Streamlit Cloud.
# It tells the platform which Python libraries to install.
# Your app requires the following:
#
# streamlit
# pandas
# plotly
#
# Please create a file named requirements.txt in the same directory as this app.py file
# and add the list of libraries above to it.
        ...
        for c in st.session_state.classes:
            ...
            with st.container(border=True):
                ...
                if is_booked:
                    ...
                    if col3.button("Book Now", key=f"book_{c['ID']}", use_container_width=True):
